    ...
    <script>
        $(document).ready(function() {
            ...
            $('#example1').DataTable({
                ...
                serverSide: true,
                searching: true,
                ajax: "{{ route('slider.ajax-datatable') }}",
                columns: [{
                        data: "id_slider",
                        name: "id_slider",
                    ...
                    },
                    {
                        ...
                        name: "image",
                        render: function(data, type, row, meta) {
                            return '<img src="{{ url('storage/slider') }}/' + data + '" class="img-thumbnail" width="200px">';
                        }
                    },
                    {
                        data: "url",
            ...
            $("#example1").on("click", ".open-edit", function(){
                ...
                $("#url").val(url);
                $('#form').attr('action', '{{route("slider.editSlider")}}');
            });
            ...
            $("#button_tambah").click(function(){
                $("#id_slider").val('');
                $("#url").val('');
                $('#form').attr('action', '{{route("slider.addSlider")}}');
            });
        });
