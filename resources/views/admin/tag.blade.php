            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1><i class="fas fa-hashtag mr-2"></i> News Tag Management</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="{{route('admin.manageTag')}}">Home</a></li>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="fas fa-hashtag mr-2"></i> News Tag Management</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                                ...
                                                <form id="form" action="{{route('admin.addUser')}}" method="POST">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="name"
                                                            name="name" placeholder="ex : Technology" />
                                                    </div>
                                            </div>
